...
*global prices 	"C:\Users\thorn\Dropbox\Public\KU Polit\Kandidat\UB_PITEC\price_indices"
...
global x "acti clase grupo cifra tamano tam200 bio innprod newemp innproc idin gintid idex gextid gtinn idintern invtejc tectejc auxtejc pidt pidtejc reci reot infun inapl destec patnum actin sede"
	// potential additions: export inver remu noremu mujeres
...
********************************************************************************
reshape wide $x lnemp empsq exter pidp invp tecp auxp gtinnp gintidp gextidp ///
	recip reotp, i(ident) j(year)
...
reshape long $x lnemp empsq exter pidp invp tecp auxp gtinnp gintidp gextidp ///
	recip reotp new_one new_two new_three, i(ident) j(year)
