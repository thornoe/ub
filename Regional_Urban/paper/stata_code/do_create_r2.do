...
*** Create data but raising criteria of regional personnel to 75,90,100%, line 270-275


////////////////////////////////////////////////////////////////////////////////
// Loop the whole data set for different cutoffs of R&D-to-total-sales ratio! //
////////////////////////////////////////////////////////////////////////////////
...
*** R&D expenses as share of total sales ***
gen gtinnp 	= 100 * gtinn / cifra	// R&D expenses (share of total sales)
gen gintidp = gintid * gtinnp/100	// Internal R&D expenses (share of total sales)
gen gextidp = gextid * gtinnp/100	// External R&D expenses (share of total sales)
gen recip 	= reci  * gintidp/100	// Payments to R&D researchers (share of total sales)
gen reotp 	= reot  * gintidp/100	// Payments to R&D technicians & clerks (share of total sales)

/*
foreach n of numlist 50 100 150 200 300 400 500 1000 100000000 {
	count if gtinnp > `n' & gtinnp < .
}
*/
...
/*
su gtinn cifra gtinnp gintidp gextidp recip reotp if idin==1, detail
*/


*** ln share R&D expenses of total sales ***
gen lngintidp = log(1+gintidp)	// internal R&D
gen lngextidp = log(1+gextidp)	// external R&D
...
label define lab_idin   0 "Continuity of internal R\&D: Never" 1 "Occasional" 2 "Frequent" 3 "Permanent"
label define lab_infun  0 "Continuity of basic research: Never" 1 "Occasional" 2 "Frequent" 3 "Permanent"
label define lab_inapl  0 "Continuity of applied research: Never" 1 "Occasional" 2 "Frequent" 3 "Permanent"
label define lab_destec 0 "Continuity of tech. development: Never" 1 "Occasional" 2 "Frequent" 3 "Permanent"
label define lab_exter  0 "Continuity of external R\&D only: Never" 1 "Occasional" 2 "Frequent" 3 "Permanent"
...
*** Drop Ceuta province and missing region ***
foreach t of numlist 2005/2016 {
	drop if region`t' == 18
	drop if region`t' == .
}
...
*** Collapse and sum regional R&D expenses and total sales ***
pause on
preserve
...
*** Regional R&D expenses as share of total sales ***
foreach t of numlist 2005/2016 {
...
foreach y of numlist 2005/2016 {
	drop if tamano`y' == .	// drop missing information
}
// 200-500 observations droped per year, but 2,000 for 2014 & 700 for 2016


*** Drop firms in agriculture, resource extraction, construction and energy ***
...
*** Drop if R&D ratio is above cutoff point for one or more year ***
foreach y of numlist 2005/2016 {
	drop if gtinnp`y' == .
}
...
********************************************************************************
**** Reshape back to long form and save different datasets					****
********************************************************************************
...
foreach k of numlist 0/3 {
	label variable new_`k' "Sales of new products in year t+`k'"
}

*** ln regional R&D expenses as share of total sales ***
gen lngtinnpr = log(gtinnpr)


*** labels for main R&D variables ***
label variable lngtinnpr "log R\&D expenses at region-level"
...
keep ident year clase grupo tamano tam200 bio innprod new_0 innproc idin sede ///
	...
	exter_cont new_1 new_2 new_3 region gtinnpr lngtinnpr

	
*** save for different cutoff points of regional R&D ratio ***
save regional_r2_`cc', replace
}
